...
- [hatch-fancy-pypi-readme](https://github.com/hynek/hatch-fancy-pypi-readme) 🌟(165) - Fancy PyPI READMEs with Hatch
  
- [hatch-vcs](https://github.com/ofek/hatch-vcs) 🌟(132) - Hatch plugin for versioning with your preferred VCS
  
- [hatch-jupyter-builder](https://github.com/jupyterlab/hatch-jupyter-builder) 🌟(43) - A hatch plugin to help build Jupyter packages
...
- [hatch-zipped-directory](https://github.com/dairiki/hatch-zipped-directory) 🌟(13) - Hatch plugin to build zip archives which unpack to a single specifically-named directory
